        ...
        <CardContent className="flex flex-col items-center space-y-6 p-4">
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold text-white">
              esse meu amigo thiago ai, ele gostava muito de falar com vc todos os dias
            </h1>
          </div>

          <div className="w-full h-auto aspect-square relative rounded-lg overflow-hidden max-w-[280px] mx-auto">
            <Image
              src={URLS.IMAGES.GLOWING_THIAGO || "/placeholder.svg"}
              alt="Glowing puppy"
              fill
          ...
          <p className="text-sm text-white text-center">
            de te encher o saco toda hora todo minuto igual um fdp nao ir nem tomar banho pq ficava te respondendo, te
            mandar msg no meio do trabalho atrapalhar tudo só pra ficar falando com vc
          </p>
          ...
          <p className="text-sm text-white text-center">imagem real dele só de pensar em te perder</p>
